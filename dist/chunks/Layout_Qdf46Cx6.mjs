...
const products$1 = [
	...
	},
	{
		...
		price: 2999,
		priceNote: "per dygn – inkl. transport & montering",
		description: "Scen för 5–8 musiker eller uppträdande. Byggs horisontellt 5×4 m. Hyrs enbart ut inkl. transport, montering och demontering av vår personal.",
		transport: "ingår",
		bulky: true,
	...
	},
	{
		...
		price: 3599,
		priceNote: "per dygn – inkl. transport & montering",
		description: "Professionell konsertscen för 6–9 musiker. Hyrs enbart ut inkl. transport, montering och demontering.",
		transport: "ingår",
		bulky: true,
	...
	},
	{
		...
		capacity: "6–9 personer inkl. instrument",
		price: 11999,
		priceNote: "per dygn – komplett paket inkl. transport & montering",
		description: "Komplett utomhusscen: 24m² med scentak i stål/aluminium med PVC-tak och scentrapp. Takhöjd 380 cm. Hyrs enbart inkl. transport och montering av vår personal.",
		transport: "ingår",
		bulky: true,
	...
	products: [
		{
			...
			description: "Klassisk PAR-armatur med 14 st 8W RGBW. DMX eller direktstyrning. 1 st: 79 kr, 4 st: 299 kr, 8 st: 499 kr, 12 st: 699 kr.",
			includes: [
				"14x8W RGBW",
				"Strålvinkel: 16°",
				"60W",
		...
		},
		{
			...
			description: "Modern PAR-armatur med 9 st 10W RGBW. DMX, fjärrkontroll eller ljudstyrning. 1 st: 99 kr, 4 st: 349 kr, 8 st: 599 kr.",
			includes: [
				"9x10W RGBW",
				"Strålvinkel: 16°",
				"90W",
		...
		},
		{
			...
			description: "36 st 1W UV PAR-armatur. Fluorescerande effekter. 1 st: 119 kr, 4 st: 449 kr, 8 st: 799 kr.",
			includes: [
				"36x1W UV",
				"Strålvinkel: 25°",
				"24W",
		...
		},
		{
			...
			description: "Stor PAR-armatur med 60 st 2W RGBW. 1 st: 149 kr, 4 st: 499 kr, 8 st: 899 kr.",
			includes: [
				"60x2W RGBW",
				"Strålvinkel: 25°",
				"120W",
		...
		},
		{
			...
			description: "IP65 wall wash-armatur med batteridrift 14h. 1 st: 199 kr, 4 st: 749 kr, 8 st: 1399 kr, 16 st: 2699 kr.",
			includes: [
				"4x18W RGBWA+UV",
				"Batteridrift 14h",
				"IP65 (utomhus)",
	...
	products: [
		{
			...
			description: "Rökmaskin med inbyggd RGB-belysning. Inkl 1 l rökvätska. 1 st: 349 kr, 2 st: 649 kr, 4 st: 1249 kr.",
			includes: [
				"6x3W LED RGB",
				"Dimeffekt: 85 m³/min",
		...
		},
		{
			...
			description: "Kraftfullare rökmaskin med 12 RGB-lampor. Inkl 1 l rökvätska. 1 st: 449 kr, 2 st: 849 kr, 4 st: 1699 kr.",
			includes: [
				"12x3W LED RGB",
				"Dimeffekt: 125 m³/min",
				"Trådlös fjärrkontroll",
		...
		},
		{
			...
			description: "Cold spark machine för scen, bröllop eller fest. Kräver granulat. 1 st: 499 kr, 2 st: 949 kr, 4 st: 1799 kr.",
			includes: [
				"700W",
		...
		},
		{
			...
			description: "Professionell hazer som skapar ett finfördelat dis — perfekt för att synliggöra ljusstrålar. 1 st: 649 kr, 2 st: 1 199 kr. Inkl 1 l rökvätska.",
			includes: [
				"DMX-styrning",
