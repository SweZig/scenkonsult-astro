...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  const _rokVolMap = Object.fromEntries(
    (ljusData.rok?.products ?? []).filter((p) => p.volumePricing?.length).map((p) => [p.artno, p.volumePricing])
  );
  function volRowsRok(artno) {
    const tiers = _rokVolMap[artno];
  ...
  ], "priceFrom": 349 })}  ${maybeRenderHead()}<section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16"> <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6"> ${renderComponent($$result2, "MediaCard", $$MediaCard, { "title": "R\xF6kmaskin, 1500W", "images": ["/images/ljus/pp_ljus_effekt23.png"], "videos": ["/videos/1200W_Fog_Machine_6LEDs_Remote.mp4"], "priceExcl": 349, "priceSuffix": "/st/dygn fr", "id": "rokmaskin-1500", "artno": "SK-LJS-ROK-0001", "category": "R\xF6k & pyro", "bullets": ["6\xD73W LED RGB inbyggd", "Dimeffekt: 85 m\xB3/min", "Str\xF6mf\xF6rbrukning: 1 500 W", "M\xE5tt: 397\xD7302\xD7191 mm, Vikt: 5 kg", "1 L r\xF6kv\xE4tska ing\xE5r"], "rows": volRowsRok("SK-LJS-ROK-0001") })} ${renderComponent($$result2, "MediaCard", $$MediaCard, { "title": "R\xF6kmaskin, 650W", "images": ["/images/ljus/pp_ljus_effekt24.png"], "videos": ["/videos/adj_fog_fury_jett-04.mp4"], "priceExcl": 449, "priceSuffix": "/st/dygn fr", "id": "rokmaskin-650", "artno": "SK-LJS-ROK-0002", "category": "R\xF6k & pyro", "bullets": ["12\xD73W LED RGB inbyggd", "Dimeffekt: 125 m\xB3/min", "Str\xF6mf\xF6rbrukning: 650 W", "Vikt: 10 kg", "1 L r\xF6kv\xE4tska ing\xE5r"], "rows": volRowsRok("SK-LJS-ROK-0002") })} ${renderComponent($$result2, "MediaCard", $$MediaCard, { "title": "Hazer HZ-1500 Pro", "images": ["/images/ljus/pp_ljus_rok3.png"], "videos": ["/videos/hazer-hz1500.mp4"], "priceExcl": 649, "priceSuffix": "/st/dygn fr", "id": "hazer-hz1500", "artno": "SK-LJS-ROK-0005", "category": "R\xF6k & pyro", "bullets": ["Finf\xF6rdelat dis \u2013 synligg\xF6r ljusstr\xE5lar", "DMX 512-styrning", "Touring flightcase", "Stabil kontinuerlig output", "Inkl 1 l r\xF6kv\xE4tska"], "rows": volRowsRok("SK-LJS-ROK-0005") })} ${renderComponent($$result2, "MediaCard", $$MediaCard, { "title": "Kallgnistmaskin", "images": ["/images/ljus/pp_ljus_effekt25.png"], "videos": ["/videos/Cold_Spark_Machine.mp4"], "priceExcl": 499, "priceSuffix": "/st/dygn fr", "id": "kallgnistmaskin", "artno": "SK-LJS-ROK-0003", "category": "R\xF6k & pyro", "bullets": ["Cold Spark \u2013 s\xE4kra gnisteffekter", "Effekt: 700 W, f\xF6rv\xE4rmningstid ~4 min", "DMX 512, Vikt: 8 kg"], "rows": [...volRowsRok("SK-LJS-ROK-0003"), { label: "Granulat (drivmedel)", rows: ["100 g (~3 min) \u2013 299 kr", "200 g (~6 min) \u2013 479 kr"] }] })} ${renderComponent($$result2, "MediaCard", $$MediaCard, { "title": "Konfettiavfyrare", "images": ["/images/ljus/pp_ljus_confettimaskin.png"], "priceExcl": 499, "priceSuffix": "/dygn", "id": "konfettiavfyrare", "artno": "SK-LJS-ROK-0004", "category": "R\xF6k & pyro", "bullets": ["Utskjutningsvinkel stegl\xF6st justerbar", "DMX 512 Standard", "Str\xF6mf\xF6rbrukning: 100 W", "Inkl ett konfettir\xF6r"] })} </div> </section>  <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16"> <h2 class="text-2xl font-bold text-white mb-6 border-b border-white/10 pb-3">Ljusstyrning (DMX)</h2> <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4"> ${[
