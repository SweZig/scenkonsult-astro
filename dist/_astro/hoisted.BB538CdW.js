import"./hoisted.DlaBVMPR.js";if(!window.__mcInit){let d=function(e){const o=r[e];if(!o)return;const t=document.getElementById(`${e}-area`),i=document.getElementById(`${e}-dots`);if(!t)return;const n=o.slides[o.current],c=n.type==="video",s=t.querySelector("video");s&&(s.pause(),s.src=""),c?(t.innerHTML=`
        <video
          src="${n.src}"
          autoplay
          muted
