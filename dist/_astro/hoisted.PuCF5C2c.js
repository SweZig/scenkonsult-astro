import"./hoisted.BbzQO4h0.js";document.getElementById("fbSend")?.addEventListener("click",()=>{const c=document.querySelector('input[name="feedbackType"]:checked')?.value||"Ej angiven",e=document.getElementById("fb-text")?.value.trim(),t=document.getElementById("fb-name")?.value.trim(),n=document.getElementById("fb-email")?.value.trim();if(!e){alert("Beskriv din feedback innan du skickar.");return}const d=encodeURIComponent(`Feedback-typ: ${c}
