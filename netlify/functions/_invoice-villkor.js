...
const VILLKOR_B2C = [
  ...
  ['6. Utlämning och fullmakt',
   'Inför utlämning skickar Scenkonsult en förberedelse-länk via SMS dagen innan: legitimering, signering och eventuell fullmakt åt bud eller kontaktperson. Hyresavtalet slutförs vid Scenkonsult Nordens motkvittering. Beställaren är fortsatt ansvarig för utrustningen oavsett vem som fysiskt hämtar eller tar emot den. Laddar Beställaren upp en tredje persons legitimation intygar Beställaren att samtycke finns; fullmaktshavaren ska vara myndig och verifieras vid utlämning.'],
...
const VILLKOR_B2B = [
  ...
  ['7. Utlämning, fullmakt och motkvittering',
   'Inför utlämning skickar Scenkonsult en förberedelse-länk via SMS dagen innan: legitimering, signering och eventuell fullmakt åt bud eller kontaktperson. Hyresavtalet slutförs vid Scenkonsult Nordens motkvittering vid utlämning. Beställaren är fortsatt ansvarig för utrustningen oavsett vem som fysiskt hämtar eller tar emot den. Laddar Beställaren upp en tredje persons legitimation intygar Beställaren att samtycke finns; fullmaktshavaren ska vara myndig och verifieras vid utlämning.'],
