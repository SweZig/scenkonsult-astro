...
const VILLKOR_B2C = [
  ...
  ['2. Bokning och betalning',
   'Privatpersoner betalar alltid i förskott via Swish, kort eller förskottsfaktura innan utrustningen lämnas ut. Bokningar inom 72 timmar kräver omedelbar betalning. Bokningsavgift om 49 kr (exkl. moms) tillkommer.'],
...
const VILLKOR_B2B = [
  ['1. Hyresperiod',
   'Normal hyresperiod är 22 timmar — hämtning kl 13:00 och återlämning kl 11:00 påföljande dag. Längre hyresperioder mot tillägg. Utrustning som inte återlämnas i tid debiteras extra hyresdag per påbörjat dygn.'],
  ['2. Bokning och betalning',
   'Bokning är bindande och bekräftas skriftligen. Betalning sker mot faktura (vanligen 5–30 dagar). Bokningar inom 72 timmar kräver omedelbar betalning. Bokningsavgift om 49 kr (exkl. moms) tillkommer per faktura. Dröjsmålsränta debiteras vid sen betalning (referensränta + 8 %).'],
