...
exports.handler = async (event) => {
  ...
  console.log('KONTAKT_INCOMING:', JSON.stringify({ namn, epost, sendCopy, hasMeddelande: !!meddelande }));
    ...
    if (sendCopy && epost) {
      ...
      try {
        ...
        const htmlCustomer = htmlWrapper('Vi har tagit emot ditt meddelande', `
          ...
          <p style="color:rgba(255,255,255,0.7);font-size:15px;line-height:1.7;margin:0 0 20px;">Vi har tagit emot ditt meddelande och aterkommmer inom kort. Har du brattom, ring oss pa <a href="tel:0724481000" style="color:#c4b5f4;">072-448 10 00</a>.</p>
          <div style="background:rgba(255,255,255,0.04);border-radius:8px;padding:20px;border-left:3px solid #c4b5f4;">
