...
exports.handler = async (event) => {
  ...
  try {
    ...
    let q = `${supaUrl}/rest/v1/carts?select=id,status,customer_name,customer_company,customer_email,customer_phone,event_date,return_date,delivery_time,return_time,event_location,total_excl,expires_at,confirmed_at,last_read_customer,last_read_admin,invoice_number,invoice_sent_at,invoice_paid_at,created_at,updated_at&id=not.like.SK-RESERVE-*&order=updated_at.desc`;
