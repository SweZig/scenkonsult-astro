...
exports.handler = async (event) => {
  ...
  try {
    ...
    let q = `${supaUrl}/rest/v1/carts?select=id,status,customer_name,customer_email,event_date,event_location,total_excl,expires_at,confirmed_at,last_read_customer,last_read_admin,invoice_number,invoice_sent_at,invoice_paid_at,created_at,updated_at&order=updated_at.desc`;
